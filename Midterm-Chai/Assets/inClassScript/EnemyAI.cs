...
public class EnemyAI : MonoBehaviour {
	...
	void Start () {
		...
		enemyWidth = enemySprite.bounds.extents.x; //get enemy width on x axis
		enemyHeight = enemySprite.bounds.extents.y;  //get enemy height on y axis
	...
	void FixedUpdate () {
		...
		//if enemy is blocked oris not grounded
